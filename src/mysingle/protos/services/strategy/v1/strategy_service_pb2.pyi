...
class ValidationResponse(_message.Message):
    ...
    stage: str
    def __init__(self, is_valid: _Optional[bool] = ..., errors: _Optional[_Iterable[_Union[ValidationError, _Mapping]]] = ..., warnings: _Optional[_Iterable[_Union[ValidationWarning, _Mapping]]] = ..., stage: _Optional[str] = ...) -> None: ...
...
class Strategy(_message.Message):
    ...
    user_id: str
    is_active: bool
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., user_id: _Optional[str] = ..., is_active: _Optional[bool] = ...) -> None: ...
...
class ListStrategiesRequest(_message.Message):
    ...
    limit: int
    skip: int
    def __init__(self, user_id: _Optional[str] = ..., is_active: _Optional[bool] = ..., limit: _Optional[int] = ..., skip: _Optional[int] = ...) -> None: ...
...
class ValidateStrategyResponse(_message.Message):
    ...
    errors: _containers.RepeatedScalarFieldContainer[str]
    warnings: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, is_valid: _Optional[bool] = ..., errors: _Optional[_Iterable[str]] = ..., warnings: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ArchiveStrategyResponse(_message.Message):
    ...
    def __init__(self, success: _Optional[bool] = ..., strategy_id: _Optional[str] = ..., archived_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
