...
class Parameter(_message.Message):
    __slots__ = ("name", "type", "description", "required", "default_value", "constraints", "enum_values")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., type: _Optional[str] = ..., description: _Optional[str] = ..., required: bool = ..., default_value: _Optional[str] = ..., constraints: _Optional[_Union[ParameterConstraints, _Mapping]] = ..., enum_values: _Optional[_Iterable[str]] = ...) -> None: ...
...
class Dependency(_message.Message):
    ...
    reason: str
    is_optional: bool
    def __init__(self, indicator_name: _Optional[str] = ..., reason: _Optional[str] = ..., is_optional: bool = ...) -> None: ...

class IndicatorMetadataResponse(_message.Message):
    __slots__ = ("name", "display_name", "description", "category", "tags", "parameters", "outputs", "dependencies", "min_lookback", "is_overlay", "version", "created_at", "updated_at")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    created_at: str
    updated_at: str
    def __init__(self, name: _Optional[str] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., category: _Optional[str] = ..., tags: _Optional[_Iterable[str]] = ..., parameters: _Optional[_Iterable[_Union[Parameter, _Mapping]]] = ..., outputs: _Optional[_Iterable[_Union[OutputColumn, _Mapping]]] = ..., dependencies: _Optional[_Iterable[_Union[Dependency, _Mapping]]] = ..., min_lookback: _Optional[int] = ..., is_overlay: bool = ..., version: _Optional[str] = ..., created_at: _Optional[str] = ..., updated_at: _Optional[str] = ...) -> None: ...

class CalculateIndicatorRequest(_message.Message):
    __slots__ = ("indicator_name", "params", "symbol", "interval", "start_date", "end_date", "user_id")
...
class CalculateIndicatorResponse(_message.Message):
    __slots__ = ("indicator_name", "params", "result_type", "values", "multi_values", "signals", "timestamps", "symbol", "interval", "cached")
    class ParamsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    interval: str
    cached: bool
    def __init__(self, indicator_name: _Optional[str] = ..., params: _Optional[_Mapping[str, str]] = ..., result_type: _Optional[str] = ..., values: _Optional[_Iterable[float]] = ..., multi_values: _Optional[_Mapping[str, DoubleArray]] = ..., signals: _Optional[_Iterable[str]] = ..., timestamps: _Optional[_Iterable[str]] = ..., symbol: _Optional[str] = ..., interval: _Optional[str] = ..., cached: bool = ...) -> None: ...
...
class BatchCalculateIndicatorsRequest(_message.Message):
    __slots__ = ("symbol", "interval", "start_date", "end_date", "indicators", "user_id")
    SYMBOL_FIELD_NUMBER: _ClassVar[int]
    INTERVAL_FIELD_NUMBER: _ClassVar[int]
    START_DATE_FIELD_NUMBER: _ClassVar[int]
    END_DATE_FIELD_NUMBER: _ClassVar[int]
