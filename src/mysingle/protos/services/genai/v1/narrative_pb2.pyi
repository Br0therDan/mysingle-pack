...
class GenerateReportRequest(_message.Message):
    ...
    def __init__(self, backtest_id: _Optional[str] = ..., config: _Optional[_Union[ReportConfig, _Mapping]] = ..., metadata: _Optional[_Union[_metadata_pb2.Metadata, _Mapping]] = ...) -> None: ...
...
class ReportConfig(_message.Message):
    ...
    def __init__(self, format: _Optional[_Union[ReportFormat, str]] = ..., sections: _Optional[_Iterable[_Union[ReportSection, str]]] = ..., language: _Optional[str] = ..., detail_level: _Optional[_Union[ReportDetailLevel, str]] = ...) -> None: ...
...
class GenerateReportProgress(_message.Message):
    ...
    current_stage: str
    result: ReportResult
    def __init__(self, task_id: _Optional[str] = ..., status: _Optional[_Union[ReportStatus, str]] = ..., progress_percent: _Optional[int] = ..., current_stage: _Optional[str] = ..., result: _Optional[_Union[ReportResult, _Mapping]] = ...) -> None: ...
...
class ReportResult(_message.Message):
    ...
    def __init__(self, content: _Optional[str] = ..., metadata: _Optional[_Union[ReportMetadata, _Mapping]] = ..., warnings: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ReportMetadata(_message.Message):
    ...
    model_used: str
    def __init__(self, generated_at: _Optional[int] = ..., tokens_used: _Optional[int] = ..., generation_time_ms: _Optional[int] = ..., model_used: _Optional[str] = ...) -> None: ...
...
class GetReportStatusRequest(_message.Message):
    ...
    task_id: str
    metadata: _metadata_pb2.Metadata
    def __init__(self, task_id: _Optional[str] = ..., metadata: _Optional[_Union[_metadata_pb2.Metadata, _Mapping]] = ...) -> None: ...
...
class GetReportStatusResponse(_message.Message):
    ...
    result: ReportResult
    error_message: str
    def __init__(self, task_id: _Optional[str] = ..., status: _Optional[_Union[ReportStatus, str]] = ..., progress_percent: _Optional[int] = ..., result: _Optional[_Union[ReportResult, _Mapping]] = ..., error_message: _Optional[str] = ...) -> None: ...
...
class GenerateComparisonReportRequest(_message.Message):
    ...
    config: ReportConfig
    metadata: _metadata_pb2.Metadata
    def __init__(self, backtest_ids: _Optional[_Iterable[str]] = ..., config: _Optional[_Union[ReportConfig, _Mapping]] = ..., metadata: _Optional[_Union[_metadata_pb2.Metadata, _Mapping]] = ...) -> None: ...
