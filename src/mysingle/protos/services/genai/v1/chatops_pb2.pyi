...
from common import pagination_pb2 as _pagination_pb2
...
class CloseSessionResponse(_message.Message):
    ...
    total_messages: int
    def __init__(self, success: _Optional[bool] = ..., total_tokens_used: _Optional[int] = ..., total_messages: _Optional[int] = ...) -> None: ...
