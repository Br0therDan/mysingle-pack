...
from mysingle.protos.services.genai.v1 import chatops_pb2 as services_dot_genai_dot_v1_dot_chatops__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in services/genai/v1/chatops_pb2_grpc.py depends on'
