...
from mysingle.protos.services.genai.v1 import strategy_builder_pb2 as services_dot_genai_dot_v1_dot_strategy__builder__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in services/genai/v1/strategy_builder_pb2_grpc.py depends on'
