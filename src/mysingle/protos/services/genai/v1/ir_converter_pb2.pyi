...
class ConversionOptions(_message.Message):
    ...
    def __init__(self, preserve_comments: bool = ..., optimize: bool = ..., validate_output: bool = ...) -> None: ...
...
class PreviewConversionResponse(_message.Message):
    ...
    def __init__(self, target_ir: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., preview_code: _Optional[str] = ..., warnings: _Optional[_Iterable[_Union[_error_pb2.ConversionWarning, _Mapping]]] = ..., reversible: bool = ..., metadata: _Optional[_Union[ConversionMetadata, _Mapping]] = ...) -> None: ...
...
class ExecuteConversionRequest(_message.Message):
    __slots__ = ("source_type", "target_type", "source_ir", "options", "metadata", "strategy_id")
    SOURCE_TYPE_FIELD_NUMBER: _ClassVar[int]
    TARGET_TYPE_FIELD_NUMBER: _ClassVar[int]
    SOURCE_IR_FIELD_NUMBER: _ClassVar[int]
    OPTIONS_FIELD_NUMBER: _ClassVar[int]
...
class ExecuteConversionResponse(_message.Message):
    ...
    error_message: str
    metadata: ConversionMetadata
    def __init__(self, target_ir: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., warnings: _Optional[_Iterable[_Union[_error_pb2.ConversionWarning, _Mapping]]] = ..., success: bool = ..., error_message: _Optional[str] = ..., metadata: _Optional[_Union[ConversionMetadata, _Mapping]] = ...) -> None: ...
...
class CheckConvertibilityResponse(_message.Message):
    ...
    def __init__(self, convertible: bool = ..., reason: _Optional[str] = ..., limitations: _Optional[_Iterable[str]] = ..., required_features: _Optional[_Iterable[str]] = ...) -> None: ...
