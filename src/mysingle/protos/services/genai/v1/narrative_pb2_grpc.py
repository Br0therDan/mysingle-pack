...
from mysingle.protos.services.genai.v1 import narrative_pb2 as services_dot_genai_dot_v1_dot_narrative__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in services/genai/v1/narrative_pb2_grpc.py depends on'
